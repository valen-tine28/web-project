...
import img3 from './images/img 10.svg'
import img3b from './images/img 9.svg'
import img3c from './images/img 16.svg'
import img3d from './images/img 15.svg'
...
function Img10({text, second, thrd,forth,fith,}: props) {
  return (
    <div>
