...
import img3 from './images/img 11.svg'
import img3b from './images/img 20.svg'
import img3c from './images/img 2.svg'
import img3d from './images/img 17.svg'
...
function Img11({text, second, thrd,forth,fith,}: props) {
  return (
    <div>
