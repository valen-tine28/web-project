...
import img3 from './images/img 14.svg'
import img3b from './images/img 13.svg'
import img3c from './images/img 11.svg'
import img3d from './images/img 19.svg'
...
function Img14({text, second, thrd,forth,fith,}: props) {
  return (
    <div>
