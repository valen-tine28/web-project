...
import img3 from './images/img 15.svg'
import img3b from './images/img 8.svg'
import img3c from './images/img 20.svg'
import img3d from './images/img 7.svg'
...
function Img15({text, second, thrd,forth,fith,}: props) {
  return (
    <div>
