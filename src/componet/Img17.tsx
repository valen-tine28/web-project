...
import img3 from './images/img 17.svg'
import img3b from './images/img 18.svg'
import img3c from './images/img 11.svg'
import img3d from './images/img 5.svg'
...
function Img17({text, second, thrd,forth,fith,}: props) {
  return (
    <div>
