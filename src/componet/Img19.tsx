...
import img3 from './images/img 19.svg'
import img3b from './images/img 16.svg'
import img3c from './images/img 15.svg'
import img3d from './images/img 14.svg'
...
function Img19({text, second, thrd,forth,fith,}: props) {
  return (
    <div>
