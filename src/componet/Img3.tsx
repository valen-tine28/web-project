...
import rating from './icons/Ratings.svg'
import img3 from './images/img 3.svg'
import img3b from './images/img 11.svg'
import img3c from './images/img 18.svg'
import img3d from './images/img 6.svg'
...
function Img3({text, second, thrd, forth, fith,}: props) {
  return (
    <div>
